...
public class Curso {
    ...
    public void cargarAlumnos(){
        ...
        for (int j = 0; j < 5; j++) {
            System.out.println("Ingrese alumno "+(j+1));
            this.alumnos[j]=leer.next();
        }
    }
    /**
     * Método crearCurso(): el método crear curso, le pide los valores
    ...
    public int calcularGananciaSemanal(){
        ...
        ganancia=this.getCantidadHorasPorDia()*this.getPrecioPorHora()*this.getCantidadDiasPorSemana()*this.getAlumnos().length;
