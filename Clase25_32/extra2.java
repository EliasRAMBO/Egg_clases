...
import Clase25_32.servicios.AhorcadoService;
...
public class extra2 {
     ...
     * atributos, un vector con la palabra a buscar, la cantidad de letras encontradas y 
...
* como la longitud del vector. Después ingresa la palabra en el vector, letra por letra,
...
* palabra o se quede sin intentos. Este método se llamará en el main.
    ...
    public static void main(String[] args) {
        ...
        AhorcadoService aos=new AhorcadoService();
        aos.juego();
